...
function SplashCursor({
  ...
  RAINBOW_MODE = true,
  COLOR = '#ff0000',
  /** Caps canvas backing resolution (fluid + R3F + shader stack). */
  maxPixelRatio = 1.35,
}) {
  ...
  useEffect(() => {
    ...
    document.addEventListener('visibilitychange', resumeFluidIfVisible);
    ...
    return () => {
      isActive = false;
      document.removeEventListener('visibilitychange', resumeFluidIfVisible);
